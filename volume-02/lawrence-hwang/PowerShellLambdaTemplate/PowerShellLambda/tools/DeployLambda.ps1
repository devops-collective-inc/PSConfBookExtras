...
aws cloudformation package --template-file $ServerlessTemplateFilePath --s3-bucket $s3bucketname --s3-prefix $lambdaname --output-template-file $UpdatedTemplateFilePath --region $AWSRegion
